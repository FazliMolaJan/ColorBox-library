...
public class PalettesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        mColorsRV = view.findViewById(R.id.colors);
    ...
    void setSelectorsRV() {
        ...
        RecyclerView selectorsRV = mPaletteView.findViewById(R.id.selectors);
    ...
    void setBoxToolbar() {
        ...
        TextView boxTitle = mPaletteView.findViewById(R.id.box_title);
